...
import fr.johannlecocq.testjava.scripting.jython.JythonCalculatorFactory;
 ...
 */
public class ScriptingJythonTest {

    CalculatorFactory factory = new JythonCalculatorFactory();
